Task was to predict the probability of various defects on steel plates. Submissions were evaluated using area under the ROC curve using the predicted probabilities and the ground truth targets.
